const errors = {
    ...
    itIsNecessaryToInformAtLeastOneFieldToUpdateTheBilling: 'é necessário informar ao menos um campo para fazer a atualização da cobrança',
    ...
    theChargeCannotBeDeletedEitherBecauseItIsOverdueOrPaid: 'a cobrança não pode ser deletada ou por estar vencida ou por estar paga',
    ...
    itIsNecessaryToInformAtLeastOneFieldToUpdateTheClient: 'é necessário informar ao menos um campo para fazer a atualização do cliente',
    ...
    noReturnTotalAmountChargesPaid: 'Não foi possível ter acesso ao valor total das cobranças pagas',
    noReturnTotalAmountOverdueCharges: 'Não foi possível ter acesso ao valor total das cobranças vencidas',
    noReturnTotalAmountExpectedCharges: 'Não foi possível ter acesso ao valor total das cobranças previstas',
    noReturnOverdueCharges: 'Não foi possível ter acesso aos destaques das cobranças vencidas',
    noReturnAnticipatedCharges: 'Não foi possível ter acesso aos destaques das cobranças previstas',
    noReturnBillsPaid: 'Não foi possível ter acesso aos destaques das cobranças pagas',
    noReturnFromDefaultingCustomers: 'Não foi possível ter acesso aos destaques dos clientes inadimplentes',
    noDelinquentCustomers: 'Não há clientes inadimplentes',
    noReturnFromRegularizedCustomers: 'Não foi possível ter acesso aos destaques dos clientes em dia',
